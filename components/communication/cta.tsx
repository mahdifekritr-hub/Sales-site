...
import { ArrowRight, Sparkles, X, Check, MessageSquare, Users, Shield, Zap } from "lucide-react";
...
export function CommunicationCTA() {
  ...
  const benefits = [
    { icon: Zap, text: "AI-powered community assistant" },
    { icon: Shield, text: "Enterprise-grade security" },
    { icon: Users, text: "Connect your entire community" },
    { icon: MessageSquare, text: "Multi-channel messaging" },
  ];
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-xl text-sm sm:text-base lg:text-lg text-muted-foreground px-2 sm:px-0">
            Say goodbye to communication gaps. Take control with AI-powered tools that keep residents informed, engaged, and connected.
          </p>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-3 text-sm text-muted-foreground sm:mt-4 sm:text-base">
                      Join thousands of communities who have transformed their resident communication with our platform.
                    </p>
                    ...
                    <div className="mt-6 rounded-xl border border-border/50 bg-card/50 p-4 backdrop-blur-sm sm:mt-8">
                      <p className="text-sm italic text-muted-foreground">
                        &ldquo;Our resident engagement went from 30% to over 90%. The community feed has neighbors connecting like never before.&rdquo;
                      </p>
                      <div className="mt-3 flex items-center gap-3">
                        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-accent" />
                        <div>
                          <p className="text-xs font-medium text-foreground sm:text-sm">Jennifer Martinez</p>
                          <p className="text-xs text-muted-foreground">Community Manager, Sunset Towers</p>
                        </div>
                      </div>
                    </div>
                  </div>
