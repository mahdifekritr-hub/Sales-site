...
export function CommunicationHero() {
  return (
    <section className="relative min-h-screen overflow-hidden pt-24 sm:pt-32 pb-12 sm:pb-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Build a connected community with our resident link platform. Enable seamless interaction through chats, posts, announcements, and virtual events that keep everyone informed and engaged.
          </motion.p>
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
              {["Messaging", "Announcements", "Resident Portal", "Virtual Events", "AI Assistant", "Job Board", "Notifications", "Community"].map(
                (feature) => (
                  <span key={feature} className="text-lg font-medium tracking-tight">
                    {feature}
                  </span>
                )
              )}
