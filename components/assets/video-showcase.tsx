...
export function AssetsVideoShowcase() {
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base lg:text-lg text-muted-foreground px-4 sm:px-0">
            Discover how our platform tracks assets, manages inventory, and automates parts replenishment to keep your operations running smoothly.
          </p>
        </motion.div>
            ...
            <div className="relative aspect-video rounded-xl sm:rounded-2xl overflow-hidden bg-card">
              {!isPlaying ? (
                ...
                <iframe
                  ...
                  title="Assets & Parts Module Demo"
