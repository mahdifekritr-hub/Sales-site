    ...
    <section className="relative min-h-screen overflow-hidden pt-24 sm:pt-32 pb-12 sm:pb-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            The Assets & Parts module helps you track, manage, and optimize your equipment lifecycle with QR code scanning, inventory management, and automated purchase orders for seamless operations.
          </motion.p>
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
              {["Asset Tracking", "QR Codes", "Inventory", "Parts", "Locations", "Warranties", "Reports", "Mobile"].map(
                (feature) => (
