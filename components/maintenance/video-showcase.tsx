...
export function MaintenanceVideoShowcase() {
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base lg:text-lg text-muted-foreground px-4 sm:px-0">
            Discover how our platform automates work orders, schedules preventive maintenance, and helps your team work more efficiently.
          </p>
        </motion.div>
