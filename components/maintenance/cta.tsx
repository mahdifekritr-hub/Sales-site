...
import { ArrowRight, Sparkles, X, Check, Wrench, Users, Shield, Zap } from "lucide-react";
...
export function MaintenanceCTA() {
  ...
  const benefits = [
    ...
    { icon: Wrench, text: "Full maintenance suite" },
  ];
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-xl text-sm sm:text-base lg:text-lg text-muted-foreground px-2 sm:px-0">
            Say goodbye to maintenance headaches. Take control with AI-powered tools that streamline work orders, scheduling, and asset management.
          </p>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-3 text-sm text-muted-foreground sm:mt-4 sm:text-base">
                      Join thousands of maintenance teams who have transformed their operations with our platform.
                    </p>
                    ...
                    <div className="mt-6 rounded-xl border border-border/50 bg-card/50 p-4 backdrop-blur-sm sm:mt-8">
                      <p className="text-sm italic text-muted-foreground">
                        &ldquo;This platform reduced our maintenance backlog by 60% in just the first month. Game-changing for our operations.&rdquo;
                      </p>
                      <div className="mt-3 flex items-center gap-3">
                        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-accent" />
                        <div>
                          <p className="text-xs font-medium text-foreground sm:text-sm">David Chen</p>
                          <p className="text-xs text-muted-foreground">Facility Director, Metro Properties</p>
                        </div>
                      </div>
                    </div>
                  </div>
