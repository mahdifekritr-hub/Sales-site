...
const maintenanceTasks = [
  { name: "HVAC Filter Replacement - Tower A", match: 98, priority: "High", dueDate: "Today" },
  { name: "Elevator Annual Inspection", match: 94, priority: "Medium", dueDate: "Tomorrow" },
  { name: "Fire Safety System Check", match: 91, priority: "High", dueDate: "In 3 days" },
];
...
export function MaintenanceAIMatching() {
  ...
  const conversationSteps = [
    { role: "ai", message: "Hi! I'm your maintenance AI assistant. What do you need help with today?" },
    { role: "user", message: "Show me overdue preventive maintenance tasks" },
    { role: "ai", message: "I found 5 overdue PM tasks. The most critical is the HVAC filter replacement in Tower A - it's 3 days overdue." },
    { role: "user", message: "Who's available to handle it?" },
    { role: "ai", message: "John (HVAC certified) is available and on-site. Sarah is also certified but currently on another job." },
    { role: "user", message: "Assign it to John" },
    { role: "ai", message: "Done! I've assigned the HVAC task to John and sent him a notification. He'll receive all task details and the maintenance checklist on his mobile app." },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base lg:text-lg text-muted-foreground px-4 sm:px-0">
            Our AI analyzes technician skills, availability, and workload to automatically assign maintenance tasks to the right person at the right time.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm">
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/30 px-4 py-3">
                ...
                <div>
                  <p className="text-sm font-medium">Maintenance AI</p>
                      ...
                      <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-4">
                        <div className="flex gap-3 sm:gap-4">
                          <div className={`flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-xl ${isDeferred ? "bg-chart-5/10" : "bg-primary/10"
                            ...
                            <Wrench className={`h-5 w-5 sm:h-6 sm:w-6 ${isDeferred ? "text-chart-5" : "text-primary"
                              }`} />
                          </div>
                          <div>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Optimizing task assignments</p>
                  </div>
                </div>
