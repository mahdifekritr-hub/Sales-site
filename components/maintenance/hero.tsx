    ...
    <section className="relative min-h-screen overflow-hidden pt-24 sm:pt-32 pb-12 sm:pb-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            The maintenance module helps you streamline preventive and corrective maintenance tasks, ensuring equipment and facilities remain in optimal working condition with automatic scheduling and performance tracking.
          </motion.p>
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
              {["Work Orders", "Scheduling", "Checklists", "Tracking", "Automation", "Vendors", "Reports", "Mobile"].map(
                (feature) => (
